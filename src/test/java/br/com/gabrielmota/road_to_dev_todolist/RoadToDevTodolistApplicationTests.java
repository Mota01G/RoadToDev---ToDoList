package br.com.gabrielmota.road_to_dev_todolist;
...
class TodolistApplicationTests {
	...
	void testCreateTodoSuccess() {
		...
		webTestClient
				...
				.jsonPath("$[0].descricao").isEqualTo(todo.getDescription())
				.jsonPath("$[0].realizado").isEqualTo(todo.isDone())
				.jsonPath("$[0].prioridade").isEqualTo(todo.getPriority());
	}
